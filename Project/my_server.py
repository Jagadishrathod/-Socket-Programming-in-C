...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        l_title=tk.Label(self, text="Server Portal",
                         font="Arial,12")
        ...
        logbtn = tk.Button(self, text="Login", bg="blue", fg="black",command=lambda: login_btn_clicked())
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        clock = tk.Label(self, font=('times', 18, 'bold'), bg='red',fg="black")
        ...
        label = tk.Label(self, text="Server Portal ", font="Arial,16",bg="blue",fg="White")
        label.grid(row=0, column=0, columnspan=2, padx=8, pady=8, sticky="NSNESWSE")

        l_host=tk.Label(self,text="Enter IP Address")
        ...
        def connect():
            ...
            e_host_v=e_host.get()
            e_port_v=int(e_port.get())
            _thread.start_new_thread(server,(show_1,e_host_v,e_port_v))
            #start_new_thread(server,(show_1,e_host_v,e_port_v))
            global secs
            secs = 0
...
app = Page()
app.title("Server Portal")
photo =tk.PhotoImage(file = "/home/hrishikesh/Desktop/Networking/TCP/server.png")
