...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        l_title=tk.Label(self, text="Client Portal",
                         font="Arial,12")
        l_title.grid(row=0,column=0,columnspan=3, sticky="NSEW",padx=40,pady=40)
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Client Portal ", font="Arial,16",bg="blue",fg="White")
...
photo =tk.PhotoImage(file = "/home/hrishikesh/Desktop/Networking/TCP/client.png")
